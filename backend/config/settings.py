...
SECRET_KEY = os.getenv("SECRET_KEY", "dev-only-change-me-please-use-env-in-production-32chars")
...
if DATABASE_URL:
    DATABASES = {"default": dj_database_url.config(default=DATABASE_URL, conn_max_age=600, ssl_require=os.getenv("DB_SSL", "False").lower() == "true")}
else:
    DATABASES = {
        "default": {
            "ENGINE": "django.db.backends.postgresql",
            "NAME": os.getenv("POSTGRES_DB", "team_task_manager"),
...
LOGGING = {
    ...
    "loggers": {
        "apps.accounts": {"handlers": ["console"], "level": os.getenv("AUTH_LOG_LEVEL", "INFO")},
    },
}
